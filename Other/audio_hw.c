...
// this is called firstly comment by yanan 2016-04-12 13:12:19
static void select_output_device(struct sunxi_audio_device *adev)
{
    int ret = -1;
	...
	//lkj   route this comment by yanan 2016-04-12 13:13:53
...
// route here comment by yanan 2016-04-12 13:27:29
// route here comment by yanan 2016-04-12 13:36:53
static int start_output_stream(struct sunxi_stream_out *out)
{
    ...
    // card:1, port:0, rate:44100 by yanan 2016-04-12 13:28:24
...
//		out->config.period_count = 8;
	...
	{
		ALOGV("do not use out resampler");      // route here by yanan 2016-04-12 13:28:45
	}
...
// route this comment by yanan 2016-04-12 13:23:27
...
// route here by yanan 2016-04-12 13:24:09 
static int out_set_parameters(struct audio_stream *stream, const char *kvpairs)
{
	...
	ALOGV("out_set_parameters: %s", kvpairs);   // routing=2; by yanan 2016-04-12 13:24:45
    ...
    if (ret >= 0) {
        ...
        pthread_mutex_lock(&out->lock);
        // out_device:2, val:2 by yanan 2016-04-12 13:25:20
...
// route this comment by yanan 2016-04-12 13:19:59
                                   ...
                                   struct audio_stream_out **stream_out)
{
	...
	ALOGV("adev_open_output_stream, flags: %x", flags); // flags = 2 by yanan 2016-04-12 13:20:32
    ...
    // req_sample_rate: 44100, fmt: 1, chenel_count: 3;
...
static int adev_set_voice_volume(struct audio_hw_device *dev, float volume)
{
	...
	ALOGV("adev_set_voice_volume, volume: %f", volume);     // volume:0.000000 by yanan 2016-04-12 13:27:00
...
// route this comment by yanan 2016-04-12 13:19:03
...
// route this comment by yanan 2016-04-12 13:17:55
                     ...
                     hw_device_t** device)
{
   ...
   if (ril_dev_init() < 0 ){
    ...
    // g_no_output = 1; by yanan 2016-04-12 13:21:29
    ALOGD("g_no_output =%d", g_no_output);          // route this comment by yanan 2016-04-12 13:15:08
#endif
